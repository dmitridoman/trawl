...
<head>
  ...
  <title>crawlshot — compare ${sites.length} sites — ${escapeHtml(stamp)}</title>
  <style>${css}</style>
</head>
<body>
  <h1>crawlshot — compare ${sites.length} sites</h1>
  ...
  <footer>generated by crawlshot · machine data in <code>compare.json</code></footer>
</body>
</html>`;
}
